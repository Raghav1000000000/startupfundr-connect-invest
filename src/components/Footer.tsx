        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold text-success-400">Fundr</span>
            </div>
            <p className="text-gray-400 mb-4">
              Connecting innovative startups with forward-thinking investors. Build the future together.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/investment-guide" className="text-gray-400 hover:text-white transition-colors">
                  Investment Guide
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/raise-capital" className="text-gray-400 hover:text-white transition-colors">
                  Raise Capital
                </Link>
              </li>
              <li>
                <Link to="/startup-resources" className="text-gray-400 hover:text-white transition-colors">
                  Resources
                </Link>
              </li>
              <li>
                <Link to="/startup-application" className="text-gray-400 hover:text-white transition-colors">
                  Apply Now
                </Link>
              </li>
              <li>
